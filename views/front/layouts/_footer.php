   ...
   <div class="container">
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               ...
               <p>Yakin.com merupakan portal berita kekinian</p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="row footer-bottom d-flex justify-content-between align-items-center">
         ...
         <p class="col-lg-8 col-md-8 footer-text">
            ...
            <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Yakin</a>
            <!-- Repost by sharecodingan.blogspot.com -->
